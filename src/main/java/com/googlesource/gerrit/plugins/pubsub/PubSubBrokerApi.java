...
public class PubSubBrokerApi implements BrokerApi {
  ...
  private List<PubSubEventSubscriber> subscribers;
  ...
  public boolean send(String topic, EventMessage message) {
    return publishers.putIfAbsent(topic, publisherFactory.create(topic)).publish(message);
  }
